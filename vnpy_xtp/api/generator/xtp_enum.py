...
XTP_TICKER_TYPE = {
    ...
    "XTP_TICKER_TYPE_TECH_STOCK": "int",
...
XTP_BUSINESS_TYPE = {
    ...
    "XTP_BUSINESS_TYPE_OPTION_COMBINE": "int",
    "XTP_BUSINESS_TYPE_EXECUTE_COMBINE": "int",
...
XTP_DEBT_EXTEND_OPER_STATUS = {
    "XTP_DEBT_EXTEND_OPER_PROCESSING": "int",
    "XTP_DEBT_EXTEND_OPER_SUBMITTED": "int",
    "XTP_DEBT_EXTEND_OPER_SUCCESS": "int",
    "XTP_DEBT_EXTEND_OPER_FAILED": "int",
    "XTP_DEBT_EXTEND_OPER_UNKNOWN": "int",
}
...
XTP_OPT_COVERED_OR_UNCOVERED = {
    "XTP_POSITION_UNCOVERED": "int",
    "XTP_POSITION_COVERED": "int",
}
...
XTP_OPT_POSITION_TYPE = {
    "XTP_OPT_POSITION_TYPE_CONTRACT": "int",
    "XTP_OPT_POSITION_TYPE_COMBINED": "int",
}

    "XTP_ORDER_DETAIL_TYPE_NEW_ORDER": "int",
    "XTP_ORDER_DETAIL_TYPE_CANCEL_ORDER": "int",
    "XTP_ORDER_DETAIL_TYPE_OPT_COMB_NEW_ORDER": "int",
    "XTP_ORDER_DETAIL_TYPE_OPT_COMB_CANCEL_ORDER": "int",
}

    "XTP_TERMINAL_PC": "int",
    "XTP_TERMINAL_ANDROID": "int",
    "XTP_TERMINAL_IOS": "int",
    "XTP_TERMINAL_WP": "int",
    "XTP_TERMINAL_STATION": "int",
    "XTP_TERMINAL_TEL": "int",
    "XTP_TERMINAL_PC_LINUX           ///<"OH"": "int",
}

XTP_EXPIRE_DATE_TYPE = {
    "XTP_EXP_DATE_SAME": "int",
    "XTP_EXP_DATE_DIFF": "int",
    "XTP_EXP_DATE_NON": "int",
}

XTP_UNDERLYING_TYPE = {
    "XTP_UNDERLYING_SAME": "int",
    "XTP_UNDERLYING_DIFF": "int",
    "XTP_UNDERLYING_NON": "int",
}

XTP_AUTO_SPLIT_TYPE = {
    "XTP_AUTO_SPLIT_EXPDAY": "int",
    "XTP_AUTO_SPLIT_PREDAY": "int",
    "XTP_AUTO_SPLIT_PRE2DAY": "int",
    "XTP_AUTO_SPLIT_NON": "int",
}

XTP_QUALIFICATION_TYPE = {
    "XTP_QUALIFICATION_PUBLIC": "int",
    "XTP_QUALIFICATION_COMMON": "int",
    "XTP_QUALIFICATION_ORGANIZATION": "int",
    "XTP_QUALIFICATION_UNKNOWN": "int",
}
